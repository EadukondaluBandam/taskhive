...
const { createEmployeeSchema, updateEmployeeSchema, employeeIdSchema } = require("./admin.schema");
...
router.delete("/employees/:id", validate(employeeIdSchema), asyncHandler(controller.deleteEmployee));
