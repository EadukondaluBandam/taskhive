...
export default function SetPassword() {
  ...
  return (
    <>
      <SEO
        title={isResetMode ? "Reset Your TaskHive Password" : "Set Your TaskHive Password"}
        description={isResetMode ? "Reset your TaskHive password securely." : "Set your TaskHive password to activate your account."}
        path={isResetMode ? "/reset-password" : "/set-password"}
